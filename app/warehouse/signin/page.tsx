...
export default function Signin() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const response = await axios.post('http://localhost:3008/auth/login', formData);
        ...
        <>
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                <div className=" flex items-center justify-center gap-2 mb-2">
                    ...
                    <input id="email" name="email" type="text" className="input input-bordered" placeholder="Email" value={formData.email} onChange={handleChange} />
                </div>
                <div className=" flex items-center justify-center gap-2 mb-2">
